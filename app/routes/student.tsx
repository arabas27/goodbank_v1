...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Goodbank - นักเรียน" },
    { name: "description", content: "ดูคะแนนของฉันด้วยรหัสนักเรียน" },
  ];
}
    ...
    <main className="container mx-auto px-4">
      <div className="mt-6 grid gap-4">
        <section className="card">
          <h1 className="text-lg font-semibold mb-3">ดูคะแนนนักเรียน</h1>
        ...
        {records && (
          <section className="card theme-student">
            <div className="flex items-center justify-between mb-2">
              <h2 className="font-semibold">สรุปคะแนน</h2>
              <div className="text-primary font-semibold">รวม {sum} คะแนน</div>
            </div>
